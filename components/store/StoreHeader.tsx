      ...
      <div className="ghana-bar">
        <div className="ghana-bar__message">
          <span className="ghana-flag-mini" aria-hidden="true">
            ...
            <span className="ghana-flag-mini__gold"><span className="ghana-flag-mini__star">★</span></span>
        ...
        <div className="ghana-bar__ribbon" aria-hidden="true">
          ...
          <span className="ghana-ribbon ghana-ribbon--gold"><span className="ghana-ribbon__star">★</span></span>
      ...
      <nav className="main-nav" aria-label="Primary navigation">
        <div className="main-nav__left">
          <a className="nav-tab nav-tab--active" href="/">
            <span className="nav-tab__icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M8.5 4.5L5 6.4L2.8 10L6.4 11.7L7.3 9.8V20H16.7V9.8L17.6 11.7L21.2 10L19 6.4L15.5 4.5C14.7 5.5 13.5 6 12 6C10.5 6 9.3 5.5 8.5 4.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" /></svg></span>
            <span>Fashion</span>
          </a>
          <a className="nav-tab" href="#">
            <span className="nav-tab__icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M4 8.5H20L18.7 20H5.3L4 8.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" /><path d="M8 8.5C8.2 6 9.7 4.5 12 4.5C14.3 4.5 15.8 6 16 8.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /></svg></span>
        ...
        {searchOpen && (
          <div className="search-popover" role="dialog" aria-label="Search TIAH">
            <div className="search-popover__field">
              <svg viewBox="0 0 24 24" fill="none"><circle cx="11" cy="11" r="6.5" stroke="currentColor" strokeWidth="1.7" /><path d="M16 16L21 21" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" /></svg>
